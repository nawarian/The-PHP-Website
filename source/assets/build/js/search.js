...
var fillSearchResults = function fillSearchResults(results) {
  var resultsElement = document.querySelector('.search-results');
  var resultHtml = results.map(function (_ref) {
    var _ref$item = _ref.item,
        createdAt = _ref$item.createdAt,
        title = _ref$item.title,
        description = _ref$item.description,
        url = _ref$item.url,
        imageUrl = _ref$item.imageUrl,
        imageAlt = _ref$item.imageAlt;
    return "\n        <div class=\"card\">\n          <a href=\"".concat(url, "\">\n            <div\n              class=\"card__image\"\n              style=\"background-image: url('").concat(imageUrl, "')\"\n              alt=\"").concat(imageAlt, "\"\n            ></div>\n    \n            <div class=\"card__content\">\n              <h3 class=\"card__content-heading\">").concat(title, "</h3>\n              <p>").concat(description, "</p>\n              <time>").concat(moment__WEBPACK_IMPORTED_MODULE_2___default()(createdAt * 1000).format('YYYY/MM/DD'), "</time>\n            </div>\n          </a>\n        </div>\n    ");
  }).join(' ');
  resultsElement.innerHTML = resultHtml;
};

var registerSearchListeners = function registerSearchListeners(fuse) {
  var lang = document.querySelector('html').getAttribute('lang');
  var searchInput = document.querySelector('#search-box');
  var timer = null;

  searchInput.onkeyup = function (_ref2) {
    var searchTerm = _ref2.target.value;
    ...
    timer = setTimeout(function () {
      var results = fuse.search(searchTerm).filter(function (elm) {
        return elm.item.lang === lang;
      }).filter(function (elm) {
        return elm.item.imageUrl;
      });
...
Object(whatwg_fetch__WEBPACK_IMPORTED_MODULE_3__["fetch"])('/search-index.json').then( /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(response) {
    var index, fuse;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            index = _context.sent;
            fuse = new fuse_js__WEBPACK_IMPORTED_MODULE_1__["default"](index, {
...
/***/ 1:
/*!*******************************************!*\
  !*** multi ./source/_assets/js/search.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
