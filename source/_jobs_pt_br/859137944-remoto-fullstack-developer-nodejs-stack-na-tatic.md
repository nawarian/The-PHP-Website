...
<h4>Como é ser um dev na Tatic?</h4>
<ol>
...
## Local: 
 100% Remoto
## Requisitos: 
 - Experiência em projetos com Stack Node.js 
- Conhecimento de metodos ágeis 
- Experiência com MongoDB

## Benefícios: 
 - 100% remoto
## Como se candidatar:
Candidatar-se exclusivamente através da plataforma Coodesh no link a seguir: [Fullstack Developer (Node.js Stack) na Tatic](https://coodesh.com/vagas/fullstack-dev-nodejs-stack-112034?origin=github&modal=open)
...
Fonte: https://github.com/backend-br/vagas/issues/5002