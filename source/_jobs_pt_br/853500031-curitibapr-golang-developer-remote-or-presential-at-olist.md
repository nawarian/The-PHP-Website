...
Seu papel como Golang Developer no Olist será o desenvolvimento de aplicações Go, fornecendo expertise em todo o ciclo de vida de desenvolvimento de softwares, desde o conceito e projeto até a fase de testes.
...
Você trabalhará com Go no desenvolvimento de aplicações em um ambiente que valoriza as boas práticas de programação, além de compartilhar seu conhecimento com uma equipe fera em outras slacks e cheia de vontade aprender Go.
...
- Conhecimentos avançados em Go;
- Conhecimentos em HTML5, CSS3 e Javascript básico;
...
Se inscreva [clicando aqui](https://www.pyjobs.com.br/job/2389)

## Labels



Fonte: https://github.com/backend-br/vagas/issues/4924