---
slug: 1175754185-trabalho-remoto-dev-backend-net-core-na-base2
lang: pt-br
createdAt: 2022-03-21
title: '[Trabalho Remoto] DEV BACKEND .NET CORE  na Base2 - Vaga de Emprego'
sitemap:
  lastModified: 2022-03-21
meta:
  description: 'Detalhes sobre a vaga de emprego: [Trabalho Remoto] DEV BACKEND .NET CORE  na Base2'
  twitter:
    card: summary
    site: '@nawarian'
---

# [Trabalho Remoto] DEV BACKEND .NET CORE  na Base2
...
<ul>
<li>
<p>"Se preocupar com excelência técnica e boas práticas de programação - Aqui nos preocupamos bastante com design patterns e boas práticas de arquitetura (Clean code, SOLID, DDD, TDD, BDD, etc.);</p>
</li>
<li>
<p>Ter algum conhecimento/experiência com frameworks .NET Core, .NET 5 para desenvolvimento de microserviços, e backend-for-frontend;</p>
</li>
</ul>
<h3>
...
<ul>
<li>
<p>Conhecimento e experiência no uso de Redis e RabbitMQ são diferencias.</p>
</li>
<li>
<p>Curtir a cultura ágil e ferramentas correlatas (Scrum e Kanban, principalmente)."</p>
</li>
</ul>
<h1>
...
Fonte: https://github.com/backend-br/vagas/issues/8806