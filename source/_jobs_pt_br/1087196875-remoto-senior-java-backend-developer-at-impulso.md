---
slug: 1087196875-remoto-senior-java-backend-developer-at-impulso
lang: pt-br
...
meta:
  description: 'Detalhes sobre a vaga de emprego: Buscamos Dev Sênior com experiência em Java e Spring Boot para trabalhar em uma empresa que atua com busca e comparação de preço do mercado. É necessário também ter experiência em arquitetura orientada a eventos, criação de sistemas de alta performance, microsserviços e AWS.'
  twitter:
    card: summary
    site: '@nawarian'
---
...
Buscamos Dev Sênior com experiência em Java e Spring Boot para trabalhar em uma empresa que atua com busca e comparação de preço do mercado.

É necessário também ter experiência em arquitetura orientada a eventos, criação de sistemas de alta performance, microsserviços e AWS.
...
Basta acessar o link https://impulso.link/jsY8xl, clicar no botão ‘tenho interesse’ e preencher as etapas para aplicar. Caso tenha dúvidas, envie um email para talento@impulso.work.
...
Fonte: https://github.com/backend-br/vagas/issues/8108