---
slug: 1192132010-bh-hibrido-java-senior-saber-springboot-na-base2
lang: pt-br
createdAt: 2022-04-04
title: '[BH (Híbrido)] Java sênior (saber SpringBoot) na Base2 - Vaga de Emprego'
sitemap:
  lastModified: 2022-04-04
meta:
  description: 'Detalhes sobre a vaga de emprego: [BH (Híbrido)] Java sênior (saber SpringBoot) na Base2'
  twitter:
    card: summary
    site: '@nawarian'
---

# [BH (Híbrido)] Java sênior (saber SpringBoot) na Base2
...
<ul>
<li>Java sênior (saber SpringBoot)</li>
</ul>
<h1>
...
Fonte: https://github.com/backend-br/vagas/issues/8940