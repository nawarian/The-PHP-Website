---
slug: 1098216923-bh-hibrido-desenvolvedor-fullstack-front-e-backend-substituicao-maykon-na-base2
lang: pt-br
createdAt: 2022-01-10
title: '[BH (Híbrido)] Desenvolvedor fullstack (front e backend) Substituição Maykon na Base2 - Vaga de Emprego'
sitemap:
  lastModified: 2022-01-10
meta:
  description: 'Detalhes sobre a vaga de emprego: [BH (Híbrido)] Desenvolvedor fullstack (front e backend) Substituição Maykon na Base2'
  twitter:
    card: summary
    site: '@nawarian'
---

# [BH (Híbrido)] Desenvolvedor fullstack (front e backend) Substituição Maykon na Base2
...
<ul>
<li>Desenvolvedor fullstack (front e backend) Substituição Maykon</li>
</ul>
<h1>
...
<ul>
<li>
<p>Vaga para substituição do Maykon.</p>
</li>
<li>
<p>O mesmo era Dev Júnior</p>
</li>
<li>
<p>Os requisitos solicitados quando da contratação dele foram:</p>
</li>
<li>
<p>Desenvolvedor fullstack, front e backend</p>
</li>
<li>
...
Fonte: https://github.com/backend-br/vagas/issues/8201